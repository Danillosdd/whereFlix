...
/**
 * Classe que representa a entidade TelefoneAluno no sistema.
 * Contém informações sobre o telefone de um aluno, como número,
 * se é WhatsApp e a relação com o aluno.
 */
@Entity
public class TelefoneAluno {
    ...
    /**
     * Relacionamento Many-to-One com a entidade Aluno.
     * Um telefone pertence a um único aluno.
     */
    @ManyToOne
    ...
    /**
     * Obtém o aluno associado ao telefone.
     *
    ...
    /**
     * Define o aluno associado ao telefone.
     *
